...
@push('css')
    ...
    <style>
        * {
        ...
        /* Subcategory/Mini Category Section - Matching Category Page Design */
    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-8">
            <div class="modern-products-container products">
                ...
                @if(isset($miniCategories) && $type == 0 && $miniCategories->count() > 0)
                <div class="subcategories-section">
                    <h2 class="section-title">Shop by {{ $subCategory->name ?? 'Category' }}</h2>
                    <div class="row g-4">
                        @foreach($miniCategories as $miniCategory)
                        <div class="col-6 col-md-4 col-lg-3">
                            <a href="{{ url('mini-category/' . $miniCategory->slug) }}" class="subcategory-card">
                                <div class="subcategory-image-wrapper">
                                    <img src="{{ asset('uploads/mini-category/' . ($miniCategory->cover_photo ?? 'default.png')) }}" 
                                         alt="{{ $miniCategory->name }}"
                                         class="subcategory-image"
                                         onerror="this.src='{{ asset('uploads/mini-category/default.png') }}'">
                                </div>
                                <div class="subcategory-name">
                                    <h5>{{ $miniCategory->name }}</h5>
                                </div>
                            </a>
                        </div>
                        @endforeach
