                            ...
                            <div class="card-body">
                                ...
                                <div class="col-md-12"><hr></div> 
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="Bkash" id="Bkash" placeholder="Bkash Number" class="form-control @error('Bkash') is-invalid @enderror" value="{{$vendor->shop_info->bkash ??old('Bkash')}}" >
                                    @error('Bkash')
                                 ...
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="Nagad" id="Nagad" placeholder="Nagad Number" class="form-control @error('mobile') is-invalid @enderror" value="{{$vendor->shop_info->nogod ??old('Nagad')}}" >
                                    @error('Nagad')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                 <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="Rocket" id="Rocket" placeholder="Rocket Number" class="form-control @error('Rocket') is-invalid @enderror" value="{{$vendor->shop_info->rocket ??old('Rocket')}}" >
                                    @error('Rocket')
                                        <small class="form-text text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
