<style>
    ...
    /* This rule now applies to all screen sizes */
    .sear_wrapper,
    #search-view {
        width: 100% !important;
    }
    ...
    /* Hide mobile elements on desktop and show desktop ones */
    .mobile-header-right {
        display: none;
    }
    ...
    @media(max-width: 767px) {
        ...
        .mobile-header-right ul li a sup {
            position: absolute;
            top: -6px;
            right: -11px;
...
<header class="not-home">
    ...
    <div class="top-header header_area" style="background:#f3f3f3">
        <div class="container">
            ...
            <div class="top-menu">
                <ul>
                    <li><a href="{{route('wishlist')}}"> <i class="fal fa-heart" aria-hidden="true"></i> <sup> <span>{{App\Models\wishlist::where('user_id',auth()->id())->count()}}</span></sup></a></li>
                    <li><a href="{{route('cart')}}"><i class="fal fa-shopping-basket"></i> <sup> <span>{{Cart::count()}}</span></sup> </a></li>
                    @guest
                    @else
                    <li>
            ...
            <div class="mobile-header-right">
                <ul>
                    <li><a href="javascript:void(0);" id="mobile-search-trigger"><i class="icofont icofont-search"></i></a></li>
                    <li>
                        <a href="{{route('cart')}}">
...
<script>
    $(function() {
        // When the mobile search icon is clicked, trigger a click on the main search box
        // which in turn should open the advanced search panel.
        $('#mobile-search-trigger').on('click', function(e) {
            e.preventDefault();
            $('#search-box-open').trigger('click');
        });
    });
