                    ...
                    @foreach ($categories as $key => $data)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <img src="/uploads/category/{{$data->cover_photo}}" alt="Cover Photo" width="60px">
                                @endif
                            ...
                            <td>
                                <a href="{{routeHelper('category/product/'.$data->id)}}" class="btn btn-success btn-sm">
                                ...
                                <form id="delete-data-form-{{$data->id}}" action="{{ routeHelper('category/'. $data->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                </form>
