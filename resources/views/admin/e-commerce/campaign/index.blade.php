                    ...
                    @foreach ($campaigns as $key => $data)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <img src="/uploads/campaign/{{$data->cover_photo}}" alt="Cover Photo" width="60px">
                                @endif
                            ...
                            <td>
                                ...
                                @if ($data->status)
                                <a href="{{routeHelper('campaing/status/'.$data->id)}}" class="btn btn-warning btn-sm">
                                ...
                                <form id="delete-data-form-{{$data->id}}" action="{{ routeHelper('campaing/delete/'. $data->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                                </form>
