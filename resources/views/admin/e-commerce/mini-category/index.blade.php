        ...
        <div class="card-header">
            <div class="row">
                ...
                <div class="col-sm-6 text-right">
                    <a href="{{route('admin.minicategory')}}" class="btn btn-success">
                    ...
                    @foreach ($mini_categories as $key => $data)
                        <tr>
                            ...
                            <td>
                                ...
                                @else
                                    <img src="/uploads/mini-category/{{$data->cover_photo}}" alt="Cover Photo" width="60px">
                                @endif
                                    
                            </td>
                            <td><?php if(!empty($data->subCategory->name)){echo $data->subCategory->name;}?></td>
                            <td>{{$data->name}}</td>
                            <td>
                                @if ($data->status)
                            ...
                            <td>
                                 <a href="{{routeHelper('min-category/product/'.$data->id)}}" class="btn btn-success btn-sm">
                                    <i class="fas fa-box"></i>
                                </a>
                                <a href="{{route('admin.minicategory.edit',['edit'=>$data->id])}}" class="btn btn-info btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="{{route('admin.minicategory.delete',['did'=>$data->id])}}"   class="btn btn-danger btn-sm"">
