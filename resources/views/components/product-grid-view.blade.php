    ...
    <div class="modern-product-card">
        <style>
            ...
            @media (max-width: 360px) {
                ...
                /* MODIFIED: Reduced size and kept text visible */
                .add-to-cart-btn {
                    padding: 8px 10px; /* Reduced padding slightly to accommodate text */
                    font-size: 0.7rem; /* Reduced font size for better fit */
                }
                ...
                .add-to-cart-btn svg {
                    width: 16px; /* Slightly reduced icon size to balance with text */
                    height: 16px;
                }
                /* END MODIFIED */
            }
        ...
        <div class="product-content">
            ...
            <div class="price-container">
                @if($product->discount_price > 0)
                    ...
                    <span class="discount-percentage">SAVE &#2547;{{number_format($product->regular_price - $product->discount_price, 0)}}</span>
                @else
